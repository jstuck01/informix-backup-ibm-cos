...
/**
 * Convenience class for stand alone testing of Informix-Backup-IBM-COS.
...
public class BackupRestoreTest {
	 ...
	 * arg1 is the name of the file that will be put and retrieved from object storage
	 * arg2 is the full or relative path to the InfomixCOS.jar file.  Relative path is determined
	 * from the location where BackupRestoreTest is executed from.
	 */
	public static void main(String[] args) {
		...
		System.out.println("Download Completed!  See file " + getRestoreFilename(fileName) + " for the restored object.");
	}
	
	
	/**
	 * Test method.  Streams the contents of a given file to an InformixCOS 
	 * process to test backing up file to IBM Cloud Object Storage. 
	...
	/**
	 * Test method.  Convenience method for simply putting a 
	 * file on IBM Cloud Object Storage.
	 * @param fileName
	 */
	...
	/**
	 * Test Method.  Gets a stream from an InformixCOS standard out
	...
	/**
	 * Formats the file name of an object that has been restored to include 
	 * the string _RESTORED
	 * @param inFilename is the original file name.
	 * @return the modified file name.
	 */
	private static String getRestoreFilename(String inFilename) {
		int index = inFilename.lastIndexOf(".");
		String filename = inFilename.substring(0, index) + "_RESTORED" + inFilename.substring(index, inFilename.length());
		return filename;
	}
}
