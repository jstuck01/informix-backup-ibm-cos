...
/**
 * The class COSClient is a utility to move objects to and from
 * IBM Cloud Object storage using S3 interfaces.  Movement of both 
 * large and small objects are supported.
 */
public class COSClient {
	 ...
	 * @param objectKey is a name that is to be used as this object's key in the cloud repository
	 * @param fileName is the name of the file that is to be stored in the cloud repository
	 */
	...
	/**
	 * Captures a data stream from standard input and puts the bytes onto IBM Cloud Object Storage.
	 * Supports data streams up to 5MB in size.  For larger objects, see the method backupStreamMultiPart.  
	 * @param objectKey is the name that will be used as the object store key.
	 */
	...
	/**
	 * Captures a data stream from standard input and puts the bytes onto IBM Cloud Object Storage.
	 * Data streams are separated into 5MB buffers which are transfered to the cloud.    
	 * @param objectKey is the name that will be used as the object store key.
	 */
	public void backupStreamMultiPart(String objectKey) {
		...
		try {
            ...
            InitiateMultipartUploadRequest initRequest = new InitiateMultipartUploadRequest(this.bucketName, objectKey, metadata);
	...
	/**
	 * Initiates a download stream from IBM object storage and redirects 
	 * to standard output.  
	 * @param objectKey is the key of the object to retrieve and stream.
	 */
	 ...
	 * @param objectKey is the key of the object to be removed
	 */
     ...
     * @param api_key is the key to the object store
     * @param service_instance_id is the IBM Cloud service instance
     * @param endpoint_url is the service endpoint
     * @param location is the geo location
     * @return AmazonS3
     */
    public AmazonS3 createClient(String api_key, String service_instance_id, String endpoint_url, String location)
    {
        ...
        ClientConfiguration clientConfig = new ClientConfiguration().withRequestTimeout(this.configurationBean.getClientTimeOut());
