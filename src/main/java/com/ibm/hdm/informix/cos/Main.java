...
public final class Main {
	 ...
	 * @param args The arguments for the runtime. 
	 * Arg1 is the requested operation to be performed.  BACKUP, RESTORE or DROP.  
	 * Arg2 is the IBM Cloud Object store object key to be used in the requested operation 
	 */
